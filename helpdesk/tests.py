...
class AccessControlTests(TestCase):
    ...
    def test_manager_can_add_user(self):
        ...
        self.assertTrue(CustomUser.objects.filter(email='new_emp@company.com').exists())
        new_user = CustomUser.objects.get(email='new_emp@company.com')
...
class RegistrationAndUiTests(TestCase):
    ...
    def test_registration_flow_success(self):
        ...
        self.assertEqual(response.status_code, 302)
        self.assertTrue(CustomUser.objects.filter(email='newuser@company.com').exists())
    ...
    def test_registration_validation_empty_fields(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertFalse(CustomUser.objects.filter(email='newuser@company.com').exists())
    ...
    def test_registration_validation_duplicate_email(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(CustomUser.objects.filter(email='emp@company.com').count(), 1)
